...
print(f"   最终树数量: d4={final_n_depth4}, d3={final_n_depth3}, lgbm={final_n_lgbm}, cat={final_n_cat}")
...
plt.tight_layout()
plt.savefig("feature_importance_v42.png", dpi=150)
print("\n   特征重要性图: feature_importance_v42.png")
